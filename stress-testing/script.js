...
export let options = {
    scenarios: {
        ...
        // scenario3: {
        //     executor: 'constant-arrival-rate',
        //     rate: 15, // number of iterations to execute each second
        ...
        //     exec: 'toxicity', // Function to be executed
        // },
        scenario4: {
            executor: 'constant-arrival-rate',
            rate: 25, // number of iterations to execute each second
            timeUnit: '1s', // iterations per second
            duration: '3m', // total duration
            preAllocatedVUs: 25, // initial pool of VUs
            maxVUs: 50, // maximum number of VUs
            exec: 'textEmbedding', // Function to be executed
        },
